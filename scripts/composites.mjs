...
const ceramic = new CeramicClient("https://ceramic-ethdenver2023.hirenodes.io/");
...
const authenticate = async () => {
  const key = fromString('daaae0e8b40bf78a005aa6ffbd9dbd048a162bdabb25acdc247708bea1c2f757', "base16");
  const did = new DID({
